...
const Dashboard = () => {
    ...
    useEffect(() => {
        ...
        if (token) {
            axios.get('https://fitzura-backend.onrender.com/api/dashboard', {
                headers: { Authorization: `Bearer ${token}` }
            })
            .then(res => {
                setUser(res.data.user);
                setWorkouts(res.data.user.workouts);
                axios.get('https://fitzura-backend.onrender.com/api/dashboard/stats', {
                    headers: { Authorization: `Bearer ${token}` }
                })
                .then(statRes => {
    ...
    const handleAddWorkout = () => {
        ...
        axios.post('https://fitzura-backend.onrender.com/api/add-workout', workoutData, {
